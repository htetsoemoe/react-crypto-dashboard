            ...
            >
                ...
                <div className="flex justify-between mb-10 pr-3 sm:px-2">
                    ...
                    <NavLink end to="/" className="block">
                        ...
                        <div className="items-end text-orange-300 text-5xl">
                            <SiBitcoin />
                        </div>
                    </NavLink>
                </div>
                        ...
                        <ul className="mt-3">
                            ...
                            <li className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${pathname.includes('prices') && 'bg-slate-900 underline'}`}>
                                <NavLink
                                    ...
                                    to="/prices"
                                    className={`block text-slate-200 truncate transition duration-150 ${pathname.includes('prices') ? 'hover:text-slate-200' : 'hover:text-white'
                                        }`}
                                >
                                    <div className="flex items-center">
                                        <div className="">
                            ...
                            <li className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${pathname.includes('wallet') && 'bg-slate-900 underline'}`}>
                                <NavLink
                                    ...
                                    to="/wallet"
                                    className={`block text-slate-200 truncate transition duration-150 ${pathname.includes('wallet') ? 'hover:text-slate-200' : 'hover:text-white'
                                        }`}
                                >
                                    <div className="flex items-center">
                                        <div className="">
                            ...
                            <li className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${pathname.includes('setting') && 'bg-slate-900 underline'}`}>
                                <NavLink
                                    ...
                                    to="/setting"
                                    className={`block text-slate-200 truncate transition duration-150 ${pathname.includes('setting') ? 'hover:text-slate-200' : 'hover:text-white'
                                        }`}
                                >
                                    <div className="flex items-center">
                                        <div className="">
